...
function Main() {
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 px-40 py-20 bg-blue-300">
        <div className="card rounded-md shadow-md hover:shadow-xl bg-white">
          ...
          <p className="text-justify text-sm p-5">
