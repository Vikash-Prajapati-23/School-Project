    ...
    <div>
      ...
      <div className="bg-white pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 p-7 md:p-10 lg:px-40">
          <div className="relative  hover:shadow-xl hover:scale-105 transition-all ease-out delay-400 bg-gray-50 rounded-md shadow-md">
            <img
              src={Popular}
              alt="image"
              style={{
            ...
            <p className="px-4 py-2 text-justify text-xs md:text-sm mb-3">
              ...
              iusto voluptatem quas quo ducimus, vel ratione quam fuga
              accusantium eum.
            </p>
            <Separator />
            <div>
              <div className="max-w-md text-xs md:text-sm mx-auto p-4 space-y-3">
                ...
                <Separator />
                <div className="flex justify-between  px-8 md:px-10">
                  <span className=" font-bold text-gray-700">Tuition Fee</span>
